...
Además, puedes extraer la configuración desde otras partes de tu aplicación, como controladores o componentes, usando inyección de dependencias. Ver la sección de [Inyección de Dependencias](/es/fundamental-concepts/di/) para más detalles.
