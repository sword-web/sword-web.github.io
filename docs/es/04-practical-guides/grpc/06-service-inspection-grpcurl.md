...
Para recomendaciones de diseño del contrato `.proto`, revisa [Fundamentos y contratos gRPC](/es/practical-guides/grpc/protocol-buffers).
...
Para que reflection exponga tus servicios y tipos, tu `build.rs` debe generar `sword_descriptor_set.bin` en `OUT_DIR`. Ver [Fundamentos y contratos gRPC](/es/practical-guides/grpc/protocol-buffers).
:::
