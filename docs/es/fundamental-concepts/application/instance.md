...
Si quieres usar la señal de `graceful-shutdown` predeterminada proporcionada por Sword, habilita la opción `graceful-shutdown` en tu archivo de configuración. (Ver [Configuración](../key-concepts/configuration/application.md))
